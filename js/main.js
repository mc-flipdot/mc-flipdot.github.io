...
$(function () {
  ...
  // ---------------------------------------------------------------------------
    ...
    var options = {
        aspectRatio: (globalWidth+4) / (globalHeight+4),
    //    preview: '.img-preview',
        crop: function(e) {
            setTimeout(function(){
                convertToBW($image)
    ...
    $("#download").click(function(){
        ...
        uploadAll().then(url => {
            ...
            str += "nc 192.168.178.87 1337 < /tmp/out.png";
...
function _reallyConvertToBW(canvas) {
    ...
    for (var j = 0; j < globalHeight; j++) {
        for (var i = 0; i < globalWidth; i++) {
